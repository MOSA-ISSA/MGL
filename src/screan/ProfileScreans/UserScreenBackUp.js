...
import { View, Text, Button, BackHandler, Alert,ImageBackground,Image,Pressable,FlatList, StyleSheet, TouchableOpacity, ScrollView} from 'react-native';
  ...
  return (
    <View style={{flex:1, backgroundColor: '#0d516a',}}>
      <ScrollView style={{flex:1}}>
        ...
        {/* <Button  title='log out' onPress={logout}/>                   +  my button -> componnt
        <Button title='delete acaunt' onPress={deleteAcaunt}/> */}
...
const styles = StyleSheet.create({
  ...
  text :{fontSize:20,fontWeight:'500',color:'black',margin:5},
  ...
  editButton:{height:30,width:30,borderRadius:5,borderWidth:1,borderColor:'#199',padding:2,},
